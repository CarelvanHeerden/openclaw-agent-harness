...
export function runningSessionIds(): string[] { return internalRunningSessionIds(); }
...
export function isStrictReadinessAudit(input: StrictReadinessAuditShape): boolean {
