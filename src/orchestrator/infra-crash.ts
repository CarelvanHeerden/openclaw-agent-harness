 ...
 */
export const INFRA_CRASH_RE =
  /\bENOSPC\b|no space left on device|disk quota exceeded|\bENOMEM\b|cannot allocate memory|\bEIO\b|\bEMFILE\b|too many open files|\bECONNRESET\b|socket hang up|\bETIMEDOUT\b|\bEPIPE\b/i;
 ...
 */
export function isInfraCrash(text: string): boolean {
