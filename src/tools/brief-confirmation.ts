...
export function renderBriefConfirmation(input: RenderConfirmationInput): string {
  ...
  lines.push("");
  lines.push(
    `OpenClaw, before you relay this: add your own statement of what you understood the operator to be ` +
  ...
  lines.push("");
  lines.push(
    `If you are the operator and no "${UNDERSTANDING_HEADING}" paragraph arrived with this, or this brief ` +
