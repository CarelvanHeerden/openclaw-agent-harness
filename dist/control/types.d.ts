export declare const CONTROL_STATES: readonly ["draft", "awaiting_confirmation", "autonomous_run", "pr_ready", "awaiting_merge", "done", "failed", "cancelled"];
...
export declare const SAFE_AUTHORITY_ACTIONS: readonly ["implement", "retry", "repair", "test", "commit", "push_feature_branch", "open_pull_request", "update_pull_request", "deploy"];
...
export type AuthorityTerminationReason = "replay" | "expired" | "identity_mismatch" | "conversation_mismatch" | "repository_mismatch" | "base_ref_mismatch" | "brief_digest_mismatch" | "policy_digest_mismatch" | "action_not_allowed" | "path_out_of_scope" | "budget_expansion" | "time_expansion" | "cycle_expansion" | "retry_expansion" | "security_expansion" | "credential_change" | "irreversible_side_effect" | "undeclared_deployment" | "default_branch_push";
export type AuthorityDecision = Readonly<{
    outcome: "approve";
    reason: "in_envelope";
} | {
    outcome: "terminate";
    reason: AuthorityTerminationReason;
}>;
