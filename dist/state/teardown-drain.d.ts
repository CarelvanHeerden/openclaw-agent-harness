...
export type DrainAction = {
    kind: "keep-waiting";
    reason: "loops-still-running" | "loop-still-progressing";
} | {
    kind: "drain-complete";
} | {
    kind: "force-teardown";
    reason: "loops-wedged-stale";
};
 ...
 */
export declare function decideDrainAction(input: DrainDecisionInput): DrainAction;
//# sourceMappingURL=teardown-drain.d.ts.map