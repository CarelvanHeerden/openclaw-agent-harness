 ...
 */
export function checkTokenIdentity(recordedLogin, presentedLogin) {
    ...
    if (!presented) {
        return {
            ...
            kind: "unattested",
            recorded,
            message: `This credential belongs to '${recorded}', and the token you supplied did not identify its account, ` +
    ...
    if (!same(recorded, presented)) {
        return {
            ...
            recorded,
            presented,
            message: `This credential belongs to '${recorded}', but the token you supplied authenticates as '${presented}'. ` +
