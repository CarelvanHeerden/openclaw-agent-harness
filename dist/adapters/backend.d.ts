 ...
 */
export type RoleName = "worker" | "scout" | "lead" | "adversary" | "classifier" | "crystalliser" | "revise_spec" | "worker_context";
...
export declare const ROLE_SHAPES: Readonly<Record<RoleName, RoleShape>>;
/**
...
export declare function tierAtLeast(actual: CapabilityTier, floor: CapabilityTier): boolean;
/**
 ...
 */
export declare const ROLE_MIN_TIER: Readonly<Record<RoleName, CapabilityTier>>;
 ...
 */
export declare function checkCapabilityFloor(role: RoleName, caps: BackendCapabilities, declaredTier: CapabilityTier): string | null;
/**
 ...
 */
export declare function subTaskSizingInstruction(workerTier: CapabilityTier): string;
