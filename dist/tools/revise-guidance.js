 ...
 */
export function normaliseGuidance(raw) {
 ...
 */
export function guidanceAcceptanceLine(text) {
    return (`${OPERATOR_GUIDANCE_LABEL} (free-text direction from the human who requested it, written after reading the findings below): ${text} ` +
 ...
 */
export function guidanceCommentSection(text) {
    return [
...
//# sourceMappingURL=revise-guidance.js.map