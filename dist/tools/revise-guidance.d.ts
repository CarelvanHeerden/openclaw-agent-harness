...
export declare const OPERATOR_GUIDANCE_LABEL = "OPERATOR GUIDANCE FOR THIS REVISE";
/**
 ...
 */
export declare function normaliseGuidance(raw: unknown): string | undefined;
/**
 ...
 */
export declare function guidanceAcceptanceLine(text: string): string;
/**
 ...
 */
export declare function guidanceCommentSection(text: string): string[];
//# sourceMappingURL=revise-guidance.d.ts.map