...
const NOT_TOUCHED_RE = /\b(?:did not|didn'?t|do not|don'?t|not|never)\s+(?:touch|modif|chang|edit|alter|writ|updat)\w*\b|\b(?:left|leav\w*|kept|remain\w*)\s+(?:it\s+)?(?:untouched|unchanged|as[-\s]is|as\s+it\s+was)\b|\balready\s+(?:correct|complete|fine|good|in\s+place|exists?)\b/i;
...
//# sourceMappingURL=worker-confab-detect.js.map