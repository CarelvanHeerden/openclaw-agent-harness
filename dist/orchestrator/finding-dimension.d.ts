 ...
 */
export declare function normaliseDimension(raw: string | null | undefined): CanonicalDimension | "";
 ...
 */
export declare function isRoutable(f: DimensionalFinding): boolean;
/**
 ...
 */
export declare function isBroadcastOnly(f: DimensionalFinding): boolean;
/**
 ...
 */
export declare function isMetaDimension(f: DimensionalFinding): boolean;
//# sourceMappingURL=finding-dimension.d.ts.map