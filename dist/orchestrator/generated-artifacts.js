...
export function describeStaleGeneratedArtifact(path, owner) {
    return (`${path} is a GENERATED artifact owned by \`npm run ${owner.script}\` and was NOT rewritten in this window. ` +
