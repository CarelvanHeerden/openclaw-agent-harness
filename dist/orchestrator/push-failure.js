...
const PATTERNS = [
    {
        ...
        remedy: "Grant the `workflow` scope to the token this repo routes to (classic PAT: tick `workflow`; fine-grained: Repository permissions -> Workflows -> Read and write), then push the preserved branch. " +
...
export function diagnosePushFailure(err) {
...
//# sourceMappingURL=push-failure.js.map