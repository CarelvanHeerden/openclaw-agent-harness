...
export declare const DEFAULT_REPAIR_RESERVE_RATIO = 0.3;
/**
 ...
 */
export declare const MAX_REPAIR_RESERVE_RATIO = 0.5;
...
export declare function resolveBudgetPolicy(input: {
 ...
 */
export declare function projectCycleCostUsd(spentUsd: number, cyclesRan: number): number;
...
export type RepairFunding = {
    funded: true;
    basis: "first_repair" | "reserve_covers_projection";
} | {
    funded: false;
    basis: "no_reserve" | "reserve_exhausted";
    shortfallUsd: number;
};
/**
 ...
 */
export declare function assessRepairFunding(input: RepairFundingInput): RepairFunding;
/** One line an operator can act on, for the audit trail and the decline notice. */
export declare function describeBudgetPolicy(policy: BudgetPolicy): string;
